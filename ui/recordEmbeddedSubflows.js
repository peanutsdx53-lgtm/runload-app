...
export function renderEmbeddedSubjectiveSubflow(feedback = {}) {
  ...
  return `<div class="subscreen subscreen--subjective" data-record-subflow="subjective" hidden aria-labelledby="record-body-subflow-title"><header><button type="button" class="record-subscreen__back" data-action="close-record-subflow">← <span>今日の記録へ戻る</span></button><strong id="record-body-subflow-title">身体の記録</strong><span aria-hidden="true"></span></header><main><section class="sub-flow"><div class="sub-flow-head"><p class="eyebrow">BODY RECORD</p><h2>今回の身体記録</h2><p>入力しない状態と、確認した状態を分けて残します。</p></div>
...
export function renderEmbeddedPersonalSubflow(record = {}, settings = {}) {
  ...
  return `<div class="subscreen subscreen--personal" data-record-subflow="personal" hidden aria-labelledby="record-personal-subflow-title"><header><button type="button" class="record-subscreen__back" data-action="close-record-subflow">← <span>今日の記録へ戻る</span></button><strong id="record-personal-subflow-title">今回のシューズ</strong><span aria-hidden="true"></span></header><main><section class="sub-flow"><div class="sub-flow-head"><p class="eyebrow">SHOES</p><h2>今回のシューズ</h2><p>今回使ったシューズと、意識したことだけを残します。</p></div>
