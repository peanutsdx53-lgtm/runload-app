...
const SCREEN_TUTORIALS = Object.freeze({
  ...
  result: Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ title: "2/3 12部位の身体図を見る", body: "12部位それぞれについて、その部位自身の基準100に対するReference-100を確認します。走行距離は別の走行事実として扱い、部位どうしを順位付けしません。" }),
  ...
  plan: Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ title: "2/3 予定条件を入力する", body: "距離、実走予定時間、走行形式、コースを分かる範囲で入力します。" }),
