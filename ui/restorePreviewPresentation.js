...
function statusCopy(status) {
  ...
  if (status === "REVIEW_REQUIRED") return { label: "要確認", tone: "attention", title: "確認してから復元できます", description: "復元可能ですが、参照がない項目などがあります。自分で書いた文章や予定は保持されます。" };
