...
const LEGACY_ROF_J_SEMANTIC_VERSIONS = Object.freeze([
  "ROF_J_SUZUKI_ARAI_2026_RUNLOAD_V1",
]);
const LEGACY_ROF_J_STORAGE_SCHEMA_VERSIONS = Object.freeze([
  "RUNLOAD_SECOND_PILLAR_ROFJ_STORAGE_V1",
]);
const LEGACY_ROF_J_LIFECYCLE_SCHEMA_VERSIONS = Object.freeze([
