...
function buildEvidenceInterpretation(targetExperience = null, currentRegions = []) {
  ...
  return Object.freeze({
    contract: INTERPRETATION_BASE_EVIDENCE_CONTRACT,
...
export function buildBaseInterpretation({ targetExperience = null, allExperiences = [], rofSummary = null, rofRecentReferences = {}, origin = "", selectedRegionId = "", supportDecision = null } = {}) {
  if (!targetExperience?.record) {
    ...
    return Object.freeze({
      schemaVersion: INTERPRETATION_BASE_SCHEMA_VERSION,
      coreVersion: INTERPRETATION_BASE_VERSION,
      targetRecordId: "",
      ...
      evidence: Object.freeze({ contract: INTERPRETATION_BASE_EVIDENCE_CONTRACT, regions: Object.freeze({}), completeness: Object.freeze({ completePerContributionTrace: false, wordingCode: "DO_NOT_CLAIM_FULL_BIBLIOGRAPHY" }) }),
      safety,
