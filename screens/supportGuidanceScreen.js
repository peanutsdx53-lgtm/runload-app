...
export function renderSupportGuidanceScreen({ context } = {}) {
  ...
  return `<div class="screen screen--support-guidance screen-layout screen-layout--support secondary-derived-screen">
    ...
    <section class="head"><p class="eyebrow">PUBLIC SUPPORT</p><h1>公的サポート</h1><p>症状や体調について、このアプリとは別の公的な窓口を確認します。</p></section>
    <p class="notice">この画面はこのアプリの部位ごとの目安や疲労感の値から緊急性を判定するものではありません。</p><p class="visually-hidden">このアプリの数値表示ではなく、本人の症状や体調をもとに公的窓口を選びます。このアプリは緊急性、診断、受診要否を判定しません。</p>
    <div class="cards">
      <article class="card urgent"><small>緊急時</small><strong>生命に関わる緊急性がある場合</strong><p>アプリの画面操作を続けず、地域の緊急通報を利用してください。日本では119です。</p><a href="tel:119"><span>119へ電話</span><span>›</span></a></article>
