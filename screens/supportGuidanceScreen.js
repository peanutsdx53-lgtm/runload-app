export function renderSupportGuidanceScreen() {
  return `<div class="screen screen--support-guidance prototype-parity prototype-parity--support">
    ...
    <p class="notice">この画面はRunLoadのReference-100や疲労感の値から緊急性を判定するものではありません。</p><p class="visually-hidden">RunLoadの数値表示ではなく、本人の症状や体調をもとに公的窓口を選びます。RunLoadは緊急性、診断、受診要否を判定しません。</p>
    <div class="cards">
    ...
    <a class="back" href="#/consultation">‹ 相談用にまとめるへ戻る</a>
  </div>`;
}
