...
Latest iOS scroll-surface resume recovery: 251/251 tests, 16/16 retained suites and 80/80 JS/MJS syntax PASS using the retained V1.6R2 regression harness with its cache-version literal updated for the current release. Dedicated resume static audit: 13/13 PASS. Protected calculation core hashes are unchanged. Final foreground-resume behavior still requires real-device iPhone confirmation.
