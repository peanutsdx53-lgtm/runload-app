...
await test('PLAN-DERIVED-BACK-RETURNS-TO-SAME-REGION',()=>{
...
await test('CONSULTATION-DERIVED-BACK-RETURNS-TO-SAME-REGION',()=>{
...
await test('READING-DERIVED-BACK-RETURNS-TO-SAME-REGION',()=>{
...
console.log(JSON.stringify({suite:'Interpretation Derived Navigation',total:results.length,passed:results.length-failed.length,failed:failed.length,status:failed.length?'FAIL':'PASS',results},null,2));
